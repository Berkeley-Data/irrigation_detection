...
big_earth_path ='/workspace/app/data/raw/BigEarthNet/'
...
# %%
splitst = glob(f"{big_earth_models_folder}{'splits/train.csv'}")
splitst
...
try:
    for csv_file in csv_file_path_list:
        splits = glob(f"{big_earth_models_folder}{csv_file}") # all patch folders 
        print(csv_file)
...
label_indices # Dictionary with labels
